    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end justify-between gap-2">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold tracking-tight">Ofertas</h1>
          </div>
          <p className="mt-0.5 text-xs text-muted-foreground monospace">
            Gestiona tus ofertas y cotizaciones
          </p>
        </div>
      ...
      <div className="rounded-xl border border-border/60 bg-card/80 p-4">
        <p className="text-xs font-medium text-muted-foreground monospace tracking-wider uppercase mb-3">
          <FileText className="h-3.5 w-3.5 inline mr-1.5" />Lista de Ofertas ({total})
        </p>
        {isLoading ? (
